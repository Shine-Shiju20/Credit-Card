...
public class CreditCard_API_Steps {
    ...
    private static void updateCardInDb(String cardId, Double outstandingBalance, Double minimumDue, Boolean penaltyApplied) {
        try {
            ...
            script.append("const { Client } = require('c:/Users/shine.shiju/Downloads/Credit Card/node_modules/pg');");
            ...
            pb.directory(new java.io.File("c:\\Users\\shine.shiju\\Downloads\\Credit-Card-CreditCardAPI_Testing"));
